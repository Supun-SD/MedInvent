...
class CancelSession {
  ...
  factory CancelSession.fromRawJson(String str) =>
      CancelSession.fromJson(json.decode(str));

  static List<CancelSession> otpFromJson(String str) {
    final jsonData = json.decode(str);
    return List<CancelSession>.from(
        jsonData["data"].map((x) => CancelSession.fromJson(x)));
  }
  ...
  Map<String, dynamic> toJson() => {"cancel_id": cancel_id};
