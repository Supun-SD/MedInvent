...
class DoctorArrival {
  ...
  factory DoctorArrival.fromRawJson(String str) => DoctorArrival.fromJson(json.decode(str));


  static List<DoctorArrival> otpFromJson(String str) {
    final jsonData = json.decode(str);
    return List<DoctorArrival>.from(jsonData["data"].map((x) => DoctorArrival.fromJson(x)));
  }
